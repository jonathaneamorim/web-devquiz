...
<body>
    ...
    <div class="d-flex gap-2" id="listQuiz">
                ...
                $.ajax({
                    ...
                    */
                    success: (data, textStatus, xhr) => {
                        if(xhr.status === 200) {
                            $('#admin-session-quiz').append('<div><h2>Lista de quizzes cadastrados</h2></div>');
                            data.forEach(quiz => {
                            let item = `
                                <div class="card" style="width: 18rem;">
                                    <img src="data:image/jpeg;base64," class="card-img-top" alt="avestruz">
                                    <div class="card-body">
                                        ...
                                        <a href="quiz/responder/${quiz.id}" value="${quiz.id}" class="btn btn-primary">Deletar</a>
                                    </div>
                                </div>
                                `;
                            list += item;
                    ...
                    */
                    error: (xhr, textStatus, errorThrown) => {
                        $('#admin-session-quiz').html(`Error: ${errorThrown}`);
                    }
                })
            };
